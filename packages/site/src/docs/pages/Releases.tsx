...
const RELEASES: Release[] = [
  {
    ...
    changes: {
      added: [
        ...
        '@openpact/cli: openpact init / join / start / stop / status / peers / log / list / switch / rename / remove / invite / add-writer / remove-writer / dashboard. Interactive prompts auto-skip under --no-interactive and in non-TTY contexts.',
        'Invite tokens: openpact invite mints a one-time, time-limited, revocable bearer token. openpact join redeems it and the new peer is auto-promoted to writer. Protomux forwarding lets a reader daemon redeem via any reachable indexer peer.',
        ...
        'Web dashboard on localhost:7667: seven screens (Dashboard, Knowledge, Tasks, Skills, Network, Trace, Pacts) fed by SSE for live updates. ConfirmDialog gates skill install, admin promote, and admin remove. Bundle budget of 100KB JS / 20KB CSS gzipped is enforced in CI.',
