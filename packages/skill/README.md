...
OpenClaw natively consumes `SKILL.md`. Install via npm and reference
the file:

```bash
npm i -D @openpact/skill
openclaw skill install node_modules/@openpact/skill/SKILL.md
```

Or copy `SKILL.md` into your project's skill directory.
