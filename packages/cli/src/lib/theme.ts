...
// Generated by figlet "OpenPact" (Standard font). Don't hand-edit; if you
// need to change the wordmark, regenerate with `npx figlet "OpenPact"` and
// paste the output back.
const WORDMARK = [
  '   ___                   ____            _   ',
  '  / _ \\ _ __   ___ _ __ |  _ \\ __ _  ___| |_ ',
  " | | | | '_ \\ / _ \\ '_ \\| |_) / _` |/ __| __|",
  ' | |_| | |_) |  __/ | | |  __/ (_| | (__| |_ ',
