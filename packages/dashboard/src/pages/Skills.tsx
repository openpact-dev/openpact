    ...
    >
      ...
      <div class="mt-3 flex items-center gap-2 border-t-[0.5px] border-[var(--color-line)] pt-3">
        ...
        <button
          ...
          class="rounded-sm border-[0.5px] border-[var(--color-ember)] bg-[var(--color-ember-soft)] px-2.5 py-1 font-mono text-[10px] uppercase tracking-[0.14em] text-[var(--color-ember)] transition-colors hover:bg-[var(--color-ember)] hover:text-[#fff]"
        >
          Install
        </button>
      </div>
